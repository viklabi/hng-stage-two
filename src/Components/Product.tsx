    ...
    <div className='flex items-start flex-col w-[80%] justify-between max-w-[284px] mx-auto h-[400px] lg:h-[600px]'>
      <div className='w-full grid place-items-center'>
        ...
        <div className='grid place-items-center w-full'>
          <Button type='button' onClick={handleAddToCart} className='text-primary bg-accent text-2xl font-abhayaMedium rounded-full mt-0 mx-auto shadow-product w-[150px] h-9 flex items-center justify-center gap-2'>
          <span>Buy Now</span>
