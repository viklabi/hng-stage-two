...
const CartItem = ({name, price, quantity, src, alt, removeFromCart, id}:cartPropType) => {
 
  return (
    <div className="flex items-center ex:h-[280px] lg:h-[360px] ex:justify-between ml-[5%] lg:ml-0 ex:flex-col gap-3 pr-2 md:pr-0  md:gap-8 h-32">
      ...
      <div className=" flex items-start flex-col w-[60%] ">
       ...
       <div className="flex items-center justify-between w-full font-abhayaMedium">
        ...
        <Button type="button" className="bg-green w-[13px] h-[13px] lg:w-[35px] lg:h-[35px] shadow-cart grid place-items-center" onClick={() => console.log('-1')}>
